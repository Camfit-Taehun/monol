...
async function showStatus(learn) {
...
async function runDiscover(learn, args) {
    console.log('\n🔍 Running Discovery...\n');
    try {
...
async function runDailyScan(learn) {
    console.log('\n📅 Running Daily Scan...\n');
    try {
...
async function runWeeklyReview(learn) {
...
async function exportKnowledge(learn, outputPath) {
...
async function importKnowledge(learn, inputPath) {
    if (!inputPath) {
